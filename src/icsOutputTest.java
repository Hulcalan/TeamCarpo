...
public class icsOutputTest {
	...
	static eventNode testNode = new eventNode((long) 2015071808,
			(long) 2015071908, "Pacific/Honolulu", "PRIVATE",
			"21.2971940;-157.8151930", "UH Manoa", "Description of event",
			"Event Title", null);
	static eventNode testNode2 = new eventNode((long) 2015081808,
			(long) 2015081908, "Pacific/Honolulu", "PRIVATE",
			"21.2971940;-157.8151930", "UH Manoa", "Description of event",
			"Event Title", null);
	...
	// Tests the method to retrieve the geo location coordinates from an event
	// node
	@Test
	public void test3() {
	...
	// Tests the method to retrieve the classification (public, private etc)
	// from an event node
	@Test
	public void test5() {
	...
	// Tests the method to retrieve the reference to the next event from an
	// event node
	@Test
	public void test6() {
	...
	// Tests the toString method of event node and checks it against the
	// expected format
	@Test
	public void test9() {
		assertEquals(
	...
	public void test10() {
		...
		testLL.add((long) 2015071808, (long) 2015071908, "Pacific/Honolulu",
				"PRIVATE", "21.2971940;-157.8151930", "UH Manoa",
				"Description of event", "Event Title");
		assertEquals(
				testLL.toString(),
				"BEGIN:VCALENDAR\n"
	...
	@Test
	public void test12() {
		testLL.add((long) 2015081808, (long) 2015081908, "Pacific/Honolulu",
				"PRIVATE", "21.2971940;-157.8151930", "Kaleo", "Second event",
				"Two");
		assertEquals(
				testLL.toString(),
				"BEGIN:VCALENDAR\n"
						...
						+ "DTEND;Pacific/Honolulu20150719T08\nCLASS:PRIVATE\n"
						+ "SUMMARY:Event Title\nDESCRIPTION:Description of event"
						+ " Event Title Occurring from 2015071808 to 2015071908."
	...
	@Test
	public void test13() {
		testLL.add((long) 2015061808, (long) 2015061908, "Pacific/Honolulu",
				"PRIVATE", "21.2971940;-157.8151930", "POST", "Third event",
				"Three");
		assertEquals(
				testLL.toString(),
				"BEGIN:VCALENDAR\n"
						...
						+ "Three Occurring from 2015061808 to 2015061908."
	...
	// Tests the method geocalc which will return the distance between the two
	// coordinates entered
	@Test
	public void test14() {
		double temp = testLL.geoCalc("21.2971940;-157.8151930",
				"21.297410;-157.816244");
